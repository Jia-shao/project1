...
def fill_img_with_sd(
    ...
    pipe = StableDiffusionInpaintPipeline.from_pretrained(
        "/home/wangyj/digital_twin/Inpaint_Anything/pretrained_models/stable-diffusion-2-inpainting",
...
def replace_img_with_sd(
    ...
    pipe = StableDiffusionInpaintPipeline.from_pretrained(
        "/home/wangyj/digital_twin/Inpaint-Anything/pretrained_models/stable-diffusion-2-inpainting",
        torch_dtype=torch.float32,
    ).to(device)
